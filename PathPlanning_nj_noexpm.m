...
while iter < 200
    ...
    while c_state ==1 %loop until a theta in free space is found
        ...
        c_state = colli_nj_noexpm(S,theta_start,theta_samp,p_robot,r_robot,p_obstacle,r_obstacle); %check if the random theta is in free space
    end
    ...
    forward_cstate = colli_nj_noexpm(S,theta_fclosest,theta_samp,p_robot,r_robot,p_obstacle,r_obstacle); %check if the path from theta_fclosest to theta_samp is collisioni free
    ...
    backward_cstate = colli_nj_noexpm(S,theta_bclosest,theta_samp,p_robot,r_robot,p_obstacle,r_obstacle); %check if the path from theta_fclosest to theta_samp is collisioni free
